...
/**
 * Thrown if a {@link Stringifier} implementation did not satisfy the contract for
 * the {@code Stringifier} interface.
 *
...
public final class BadStringifierException extends RenderException {
   ...
   */
  public static BadStringifierException stringifierReturnedNull(Template tmpl,
      String varName) {
  ...
  /**
   * Thrown if a stringifier's {@link Stringifier#toString(Object) toString} method
   * threw a {@code NullPointerException}.
   */
  public static BadStringifierException stringifierNotNullResistant(Template tmpl,
      String varName) {
