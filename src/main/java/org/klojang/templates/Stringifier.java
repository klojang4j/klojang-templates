...
/**
 * A stringifier is responsible for stringifying the values coming back from
 * the data access layer. Since these can, in principle, have any type, the
 * {@link RenderSession} needs to know how to stringify them, so they can be embedded
 * in the template. This can be configured using a {@link StringifierRegistry}.
